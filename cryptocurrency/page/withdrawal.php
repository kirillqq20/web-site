...
?>
    <div class="container">
        <h1 class="pb-2 border-bottom">Write down how much you want to withdraw funds from the wallet</h1>
    </div> <br>
    <div class="container ">
        <div class="row">
            <div class="col-md-4">
...
if (isset($_POST['currency'])) {
    ...
    $insertOutDep = "INSERT INTO withdrawal (withdrawalCurrency, withdrawalAmount, withdrawalDate) VALUES ('".$currency."', '".$amount."', '".$date."')";
    if ($link ->query($insertOutDep) === true) {
        echo 'New record created successfully';
    } else {
        echo 'Error:' .  $insertOutDep . '<br>' . $link->error;
    }
    $link->close();
}
